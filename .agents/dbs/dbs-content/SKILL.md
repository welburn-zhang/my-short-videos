...
对张半蛋这个项目，内容不是先追热点、迎合观众或套爆款公式。诊断前先判断：这是不是用户真正关注的问题，是否有真实经历、观察、情绪或长期兴趣支撑，是否适合由张半蛋来讲。数据和平台反馈只作为表达优化参考。
...
当用户准备输出短视频脚本、封面文案或标题时，本 skill 是前置门槛，不是可选项。

- 先判断内容是不是用户真正想表达、是否适合张半蛋讲，再判断形式是否匹配、认知落差是否成立、表达效率是否够高。
- 先给出「能不能进入脚本 / 封面输出」的明确结论。
- 如果结论是「调整后做」，先说明要调整什么，等用户确认后再进入脚本或封面输出。
- 不要在 dbs 判断之前直接给完整脚本、封面文案或标题清单。
...
对用户的内容（或内容计划）做六个维度的诊断：

#### 维度 1：真实表达检测

- 这是不是用户真正想说的？
- 是否有真实经历、教育/职场观察、AI 使用实践、最近输入或具体情绪支撑？
- 这件事是否适合张半蛋讲，而不是换谁都能讲？
- 判断：✅ 真实且适配 / ⚠️ 需要补真实素材 / ❌ 只是迎合热点或套模板
