...
## Editing Insert-Frame Rules

When the user asks for 短视频插画分镜, 制作分镜, 插画画面, or images to insert during editing, default to **editing insert frames**, not dense storyboard sheets.
